...
def validate_manifest():
    ...
    manifest_path = Path("custom_components/easyiq/manifest.json")
...
def validate_init_file():
    ...
    init_path = Path("custom_components/easyiq/__init__.py")
...
def validate_config_flow():
    ...
    config_flow_path = Path("custom_components/easyiq/config_flow.py")
...
def validate_sensor():
    ...
    sensor_path = Path("custom_components/easyiq/sensor.py")
...
def validate_translations():
    ...
    strings_path = Path("custom_components/easyiq/strings.json")
    translations_path = Path("custom_components/easyiq/translations/en.json")
